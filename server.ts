...
const localizedResources: Record<string, LangResource> = {
  "hi": {
    ...
    hookNarrator: "ক্রিয়েটর্স आपसे TOPIC के बारे में लगातार झूठ बोल रहे हैं। सभी लोग इसे बहुत मुश्किल बताते हैं, लेकिन आज हम इस झूठ का पर्दाफाश करके आसान तरीका स्टेप-बाय-स्टेप बताएंगे।",
  ...
  "mr": {
    ...
    descriptionSnippet: "या व्हिडिओमध्ये आपण TOPIC च्या काही लपलेल्या गोष्टींविषयी सخول माहिती घेणार आहोत."
  },
  "gu": {
    titles: [
  ...
  "ben": {
    ...
    outroNarrator: "ভিডিওটি ভালো লাগলে অবশ্যই সাবস্ম্ক্রাইব করুন এবং কমেন্ট করে আমাদের সাথে শেয়ার করুন আপনার মতামত!",
    textOverlay: "দারুণ ট্রিক!",
    voiceStyle: "Premium Bengali Accent Voice",
    seoTitle: "TOPIC নিয়ে অজানা চমকপ্রদ কিছু সত্য রহস্য উন্মোচন",
    descriptionSnippet: "আজকের স্পেশال ভিডিওতে আমরা TOPIC নিয়ে খোলামেলা আলোচনা করেছি।"
  },
  "ta": {
    titles: [
  ...
  "te": {
    ...
    problemNarrator: "ప్రధాన समस्या ఏమిటంటే, సరైన గైడెన్స్ లేకుండా మనం పదే పదే ప్రయత్నిస్తూ సమయం వృధా చేసుకోవడం.",
  ...
  "ml": {
    titles: [
      ...
      "99% ആളുകളും TOPIC-ൽ പരാജയപ്പെടാൻ കാരണം ইതാണ്!",
  ...
  "pa": {
    ...
    hookNarrator: "ਦੋਸਤੋ, ਤੁਹਾਨੂੰ TOPIC ਬਾਰੇ ਹਮੇਸ਼ਾ ਗਲਤ ਰਸਤੇ ਪਾਇਆ ਗਿਆ ਹੈ। ਸਭ ਕਹਿੰਦੇ ਹਨ ਕਿ ਇਹ ਬਹੁਤ ਔਖਾ ਹੈ, ਪਰ ਅੱਜ ਅਸੀਂ ਇਸਦਾ ਪੂਰਾ ਸੱਚ ਸੌਖੇ ਤਰੀਕੇ ਨਾਲ ਸਭ ਰੱਲ ਕੇ ਸਮਝਾਂਗੇ।",
    problemNarrator: "ਅਸਲ ਗੱਲ ਇਹ ਹੈ ਕਿ ਬਿਨਾਂ ਸਹੀ ਜਾਣਕਾਰੀ ਦੇ ਅਸੀਂ ਮਿਹਨਤ ਕਰਦੇ ਜਾਂਦੇ ਹਾਂ, ਜਿਸਦਾ ਕੋਈ ਫਾਇਦਾ ਨਹੀਂ ਮਿਲਦਾ।",
    solutionNarrator: "ਕੱਲ੍ਹ ਤੋਂ ਹੀ ਇਹ ਤਿੰਨ ਨੁਸਖੇ ਆਪਣੀ ਰੋਜ਼ਮੱਰਾ ਵਿੱਚ ਅਪਲਾਈ ਕਰੋ, ਤੁਸੀਂ ਬਾਕੀਆਂ ਨਾਲੋਂ ਬਹੁਤ ਅੱਗੇ ਲੰਘ ਜਾਓਗੇ।",
    outroNarrator: "ਜੇਕਰ ਇਹ ਗੱਲਾਂ ਵਧੀਆ ਲੱਗੀਆਂ ਤਾਂ ਚੈਨਲ ਨੂੰ ਸਬਸਕ੍ਰਾਈਬ ਜ਼ਰੂਰ ਕਰਣਾ ਤੇ ਕਮੈਂਟ ਵਿੱਚ ਆਪਣੀ ਰਾਏ ਦੇਣਾ!",
  ...
  "or": {
    ...
    hooks: [
      ...
      "ଯଦି ଆପଣ ଏବେ ମଧ୍ୟ ପୁରୁଣା ଢଙ୍ଗରେ TOPIC କରୁଛନ୍ତି, ତେବେ ତୁରନ୍ତ ବନ୍ଦ କରନ୍ତୁ..."
    ],
    style: "ସରଳ, ସ୍ପଷ୍ଟ ଏବଂ ହୃଦୟସ୍ପର୍ଶୀ ଓଡ଼ିଆ ଭାଷା।",
    angle: "ସାଧାରଣ ଲୋକଙ୍କ ପାଇଁ ସହଜ ଏବଂ ପ୍ରଭାବଶାଳୀ ଗାଇଡ୍ ଦେଖାଇବା।",
    hookNarrator: "TOPIC ବିଷୟରେ ଆପଣଙ୍କୁ ଆଜି ଯାଏଁ ସବୁ ଭୁଲ କୁହାଯାଇଛି। ସମସ୍ତେ ଏହାକୁ ଜଟିଳ ମନେ କରନ୍ତି, କିନ୍ତୁ ଆଜି ଆମେ ଏହାର ପେଡ଼ି ଖୋଲିବା।",
    problemNarrator: "ପ୍ରକୃତ ସମସ୍ୟା ହେଉଛି କୌଣସି ନିର୍ଦ୍ଦିଷ୍ଟ ରଣନୀତି ନଥାଇ ଚେଷ୍ଟା କରି ସମୟ ନଷ୍ଟ କରିବା।",
    solutionNarrator: "କିନ୍ତୁ ବ୍ୟସ୍ତ ହୁଅନ୍ତୁ ନାହିଁ, ଆସନ୍ତାକାଲି ଠାରୁ କେବଳ ଏହି ତିନୋଟି ପରିବର୍ତ୍ତନ କରନ୍ତು, ଆପଣ ଅନ୍ୟମାନଙ୍କ ତୁଳନାରେ ବହୁତ ଆଗକୁ ବଢ଼ିପାରିବେ।",
    ...
    descriptionSnippet: "ଏହି ଓଡ଼ିଆ ଭୀଡିଓ ମାଧ୍ୟମରେ ଆମେ TOPIC ପାଇଁ କିଛି ଗୁରୁତ୍ଵପୂର୍ଣ୍ଣ ଗାଇଡଲାଇନ ଆଲୋଚନା କରିଛུ।"
  },
  "as": {
    titles: [
    ...
    style: "सहজ, সাবলীল আৰু মনোগ্ৰাহী অসমীয়া কথা-বতৰা।",
    ...
    outroNarrator: "যদি এই তথ্যটো ভাল লাগিছে, তেন্তে এতিয়াই চেনেলটো চাবস্ক্ৰাইব কৰক আৰু তলত কমেন্টত আপোনাৰ মতামত জناওক!",
...
function getMockData(topic: string, niche: string, videoType: string, isFallback = false, languageCode = "hi") {
  ...
  return {
    ...
    script: {
      ...
      sections: [
        {
          sectionName: videoType === "YouTube Shorts" ? "Hook (0:00 - 0:10)" : "Hook & Core Setup (0:00 - 0:30)",
        ...
        {
          sectionName: videoType === "YouTube Shorts" ? "The Twist (0:10 - 0:30)" : "The Agitation & Shock Truth (0:30 - 2:00)",
        ...
        {
          sectionName: videoType === "YouTube Shorts" ? "The Solution (0:30 - 0:50)" : "Step-by-Step Resolution Pattern (2:00 - 4:15)",
        ...
        {
          sectionName: videoType === "YouTube Shorts" ? "Outro & Loop (0:50 - 1:00)" : "The Algorithmic Call to Action (4:15 - End)",
    ...
    bRollSuggestions: [
      {
        sceneNumber: 1,
        timeframe: videoType === "YouTube Shorts" ? "0:00 - 0:15" : "0:00 - 1:00",
      ...
      {
        sceneNumber: 2,
        timeframe: videoType === "YouTube Shorts" ? "0:15 - 0:40" : "1:00 - 3:30",
      ...
      {
        sceneNumber: 3,
        timeframe: videoType === "YouTube Shorts" ? "0:40 - End" : "3:30 - End",
